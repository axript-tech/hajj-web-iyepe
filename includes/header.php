                ...
                <?php if(isset($_SESSION['user_id'])): ?>
                    <div class="flex items-center gap-4">
                        <span class="text-sm hidden md:inline opacity-90">
                            <?php echo ($user_role === 'admin') ? '<i class="fas fa-shield-alt text-hajjGold mr-1"></i> Admin' : 'Welcome, Pilgrim'; ?>
                        </span>
        ...
        <div class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-40">
            <div class="container mx-auto px-6">
                <ul class="flex flex-nowrap gap-6 text-sm font-bold text-gray-600 overflow-x-auto no-scrollbar whitespace-nowrap">
                    ...
                    <li><a href="<?php echo $base_url; ?>admin/payments.php" class="py-4 block border-b-4 <?php echo ($current_page == 'payments.php') ? 'border-hajjGold text-deepGreen' : 'border-transparent hover:text-deepGreen hover:border-gray-300'; ?> transition"><i class="fas fa-money-bill-wave mr-1"></i> Ledger</a></li>
